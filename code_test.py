...
def realtime_detection(compound_coef, camera_id, model_file_path):
    ...
    while cap.isOpened():
        ...
        with torch.no_grad():
            features, regression, classification, anchors = model.to(device)(x)
...
if __name__ == '__main__':
    realtime_detection(0, 'C:\\Users\\zamas\\Downloads\\Video\\RealSense Video Feed 11 July.mp4', 'models/efficientdet-d0.pth')
